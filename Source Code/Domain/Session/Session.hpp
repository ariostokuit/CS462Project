...
namespace Domain::Session
{
  ...
  struct StoreEmployeeSession     : SessionBase{ StoreEmployeeSession     ( const UserCredentials & credentials ); };
  struct ITEmployeeSession        : SessionBase{ ITEmployeeSession        ( const UserCredentials & credentials ); };
  struct CorporateEmployeeSession : SessionBase{ CorporateEmployeeSession ( const UserCredentials & credentials ); };
